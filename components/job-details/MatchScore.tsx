...
export function MatchScore({ matchReason, matchedSkills, missingSkills }: Props) {
  ...
  return (
    <div className="bg-surface border border-border rounded-2xl p-4 lg:p-6 shadow-sm space-y-5">
      {matchReason && (
        <section>
          <h2 className="text-sm lg:text-base font-semibold text-text-primary mb-2">AI Match Reasoning</h2>
      ...
      {matchedSkills && matchedSkills.length > 0 && (
        <section>
          <h2 className="text-sm lg:text-base font-semibold text-text-primary mb-2">Required Skills vs Your Profile</h2>
      ...
      {(!matchedSkills || matchedSkills.length === 0) && missingSkills && missingSkills.length > 0 && (
        <section>
          <h2 className="text-sm lg:text-base font-semibold text-text-primary mb-2">Missing Skills</h2>
          <div className="flex flex-wrap gap-2">
            {missingSkills.map((skill) => (
              <span
                key={skill}
